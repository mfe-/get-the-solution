...
In the above sample we used only the credentials of the registered app to access the Graph Api and App Configuration. When the registered app was set up a user was created in the Azure AD which represents our app. We then authorized this user to access our App Configuration.
