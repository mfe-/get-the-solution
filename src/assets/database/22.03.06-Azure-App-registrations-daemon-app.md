...
With Azure App Registration its possible to "run" your app as an Azure Managed Identity. The Azure Managed Identity will be granted to get access for example to a Blob Storage, App Configuration and so on. This results to maintain only the credentials of the Managed Idendity.
